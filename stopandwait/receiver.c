...
Inbox
	x
Fathima Badar <fathimabadar008@gmail.com>
	
Attachments12:56 PM (6 minutes ago)
...
---------- Forwarded message ---------
From: Gokul G <gokulg424@gmail.com>
Date: Wed, Apr 24, 2019 at 12:35 PM
Subject: stop and wait
To: Fathima Badar <fathimabadar008@gmail.com>, Eldhose Varghese <kodimattom1995@gmail.com>
...
If you want to download these and you trust this message, click "Looks safe" in the banner above.
...
{ 
   ...
   if(strcmp(send_data[counter_1].data,"yes"))
  {
    
  // printf ( "\nenter a SN for next you want to receive : " ) ;
  // scanf ( "%d",&send_data[counter_1].SN ) ;
       send_data[counter_1].SN=recv_data[counter_1].SN;
  //    printf(" %s %d ",send_data[counter_1].data,send_data[counter_1].SN);
  }
 else
    {
     
      send_data[counter_1].SN=recv_data[counter_1].SN+1;
   //  printf(" %s %d ",send_data[counter_1].data,send_data[counter_1].SN);
   }
